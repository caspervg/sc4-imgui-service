    ...
    std::optional<HookAddresses> ResolveHookAddresses(const uint16_t gameVersion)
    {
        ...
        case 641:
            return HookAddresses{
                ...
                .levelCellQuadsPtr = 0x00B4C6B0u,
                .terrainCellCountXPtr = 0x00B4C748u,
                .terrainCellCountZPtr = 0x00B4C744u,
                .terrainVertexCountXPtr = 0x00B4C750u,
                .terrainVertexCountZPtr = 0x00B4C74Cu,
